...
func (Predicate_Op) Descriptor() protoreflect.EnumDescriptor {
	return file_shared_filter_proto_enumTypes[0].Descriptor()
}

func (Predicate_Op) Type() protoreflect.EnumType {
	return &file_shared_filter_proto_enumTypes[0]
}
...
func (Predicate_Op) EnumDescriptor() ([]byte, []int) {
	return file_shared_filter_proto_rawDescGZIP(), []int{0, 0}
}
...
type Predicate struct {
	...
	Op  Predicate_Op `protobuf:"varint,1,opt,name=op,proto3,enum=shared.Predicate_Op" json:"op,omitempty"`
...
func (x *IntValues) Reset() {
	*x = IntValues{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_filter_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IntValues) Descriptor() ([]byte, []int) {
	return file_shared_filter_proto_rawDescGZIP(), []int{1}
}
...
func (x *StringValues) Reset() {
	*x = StringValues{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_filter_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StringValues) Descriptor() ([]byte, []int) {
	return file_shared_filter_proto_rawDescGZIP(), []int{2}
}
...
func (x *LongValues) Reset() {
	*x = LongValues{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_filter_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LongValues) Descriptor() ([]byte, []int) {
	return file_shared_filter_proto_rawDescGZIP(), []int{3}
}
...
func (x *Filter) Reset() {
	*x = Filter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shared_filter_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Filter) Descriptor() ([]byte, []int) {
	return file_shared_filter_proto_rawDescGZIP(), []int{4}
}
...
var file_shared_filter_proto_rawDesc = []byte{
	0x0a, 0x13, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e,
	...
	0x04, 0x0a, 0x09, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x24, 0x0a, 0x02,
	0x6f, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65,
	0x64, 0x2e, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x2e, 0x4f, 0x70, 0x52, 0x02,
	0x6f, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x12, 0x1d, 0x0a, 0x09, 0x69, 0x6e, 0x74, 0x5f, 0x76, 0x61, 0x6c, 0x75,
	...
	,
	...
	,
}

var (
	file_shared_filter_proto_rawDescOnce sync.Once
	file_shared_filter_proto_rawDescData = file_shared_filter_proto_rawDesc
)

func file_shared_filter_proto_rawDescGZIP() []byte {
	file_shared_filter_proto_rawDescOnce.Do(func() {
		file_shared_filter_proto_rawDescData = protoimpl.X.CompressGZIP(file_shared_filter_proto_rawDescData)
	})
	return file_shared_filter_proto_rawDescData
}

var file_shared_filter_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_shared_filter_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_shared_filter_proto_goTypes = []interface{}{
	(Predicate_Op)(0),             // 0: shared.Predicate.Op
	(*Predicate)(nil),             // 1: shared.Predicate
	(*IntValues)(nil),             // 2: shared.IntValues
	(*StringValues)(nil),          // 3: shared.StringValues
	(*LongValues)(nil),            // 4: shared.LongValues
	(*Filter)(nil),                // 5: shared.Filter
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_shared_filter_proto_depIdxs = []int32{
	0, // 0: shared.Predicate.op:type_name -> shared.Predicate.Op
	6, // 1: shared.Predicate.timestamp_value:type_name -> google.protobuf.Timestamp
	2, // 2: shared.Predicate.int_values:type_name -> shared.IntValues
	4, // 3: shared.Predicate.long_values:type_name -> shared.LongValues
	3, // 4: shared.Predicate.string_values:type_name -> shared.StringValues
	1, // 5: shared.Filter.predicates:type_name -> shared.Predicate
...
func file_shared_filter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_shared_filter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shared_filter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shared_filter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shared_filter_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shared_filter_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Filter); i {
			case 0:
				return &v.state
			case 1:
	...
	file_shared_filter_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_shared_filter_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		...
		EnumInfos:         file_shared_filter_proto_enumTypes,
		MessageInfos:      file_shared_filter_proto_msgTypes,
	}.Build()
	File_shared_filter_proto = out.File
	file_shared_filter_proto_rawDesc = nil
